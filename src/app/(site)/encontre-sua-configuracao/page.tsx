...
export const metadata: Metadata = {
  ...
  description:
    'Dez perguntas rápidas sobre a sua aplicação e a UPAR AI indica a categoria de computador compatível, com até três configurações relacionadas.',
  alternates: { canonical: '/encontre-sua-configuracao' },
}

const STEPS = [
  { icon: 'sliders' as const, label: 'Dez perguntas objetivas', detail: 'Leva cerca de dois minutos.' },
...
export default async function DiagnosticPage() {
  ...
  return (
    <>
      ...
      <div className="pt-12">
        <DiagnosticWizard products={products} applications={applications} />
      </div>
    </>
  )
}
